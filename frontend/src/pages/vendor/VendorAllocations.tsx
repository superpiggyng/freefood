...
export default function VendorAllocations() {
  return <DashboardShell productLabel="for Business" navItems={nav} userName="Bakers Lane" userRole="View profile">
    <header className="dashboard-heading"><div><a className="back-link" href="/vendor">← Back to dashboard</a><h1>Request allocation</h1></div><button className="button button--primary" type="submit" form="allocation-form">Run fair allocation</button></header>
